...
Codex subagent threads are retained in the local index and linked to their parent session. They stay out of the top-level session list, while expanded parent rows show how many agents participated.
